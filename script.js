...
const villaData = {
  ...
  'casa-yolanda-1': { name:'Casa Yolanda 1', tier:'Essential', area:'Buscastell',       beds:6, baths:5, sleeps:12, min:4070,  max:9240,   lat:39.0050, lng:1.3200, min_nights:7,  flexible:false, license:'ET-1073-E', tagline:'Authentic countryside villa surrounded by natural beauty', desc:'Casa Yolanda is a luxurious Ibiza rental villa with incredible views from its lavish terrace. This exclusive villa is filled with Ibizan charm and has a contemporary yet warm ambiance throughout.' },
