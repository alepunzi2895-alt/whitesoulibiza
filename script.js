...
const villaData = {
  ...
  'villa-judith':   { name:'Villa Judith',    tier:'Private',   area:'Cala Llonga',      beds:4, baths:4, sleeps:8,  min:47300, max:51700,  tagline:'Rustic-chic elegance with panoramic bay views', desc:'Set high above the sea with breathtaking views over the bay of Sol den Serra, Villa Judith combines retro vintage style with modern architecture. Steps from the legendary Amante beach club, it is one of Ibiza\'s finest boutique retreats.' },
