...
// =====================================
const villaData = {
  'villa-eliana':   { name:'Villa Eliana',   tier:'Essential', area:'San Agustín',     beds:6, baths:4, sleeps:12, min:4043,  max:13283,  lat:38.9494, lng:1.3113, min_nights:7,  flexible:false, tagline:'Chic Villa Overlooking the Sea Near San Agustin', desc:'Villa Eliana is an impressive, modern villa with fabulous panoramic views over the local countryside, down to the sea and the world-famous Ibizan sunsets. A stunning property with exceptional design and finish throughout.' },
  'villa-larish':   { name:'Villa Larish',   tier:'Essential', area:'San Rafael',       beds:6, baths:4, sleeps:12, min:6050,  max:17875,  lat:38.9700, lng:1.3600, min_nights:7,  flexible:false, tagline:'Stylish Ibiza escape where Mediterranean energy meets Tulum spirit', desc:'Villa Larish is a spacious, beautifully curated Mediterranean residence where Ibiza\'s energy meets the warm, earthy spirit of Tulum. Every corner reflects a refined aesthetic balanced by organic textures and natural light.' },
  'casa-yolanda-1': { name:'Casa Yolanda 1', tier:'Essential', area:'Buscastell',       beds:6, baths:5, sleeps:12, min:4070,  max:9240,   lat:39.0050, lng:1.3200, min_nights:7,  flexible:false, tagline:'Authentic countryside villa surrounded by natural beauty', desc:'Casa Yolanda is a luxurious Ibiza rental villa with incredible views from its lavish terrace. This exclusive villa is filled with Ibizan charm and has a contemporary yet warm ambiance throughout.' },
  'can-nora':       { name:'Can Nora',        tier:'Essential', area:'Santa Gertrudis',  beds:6, baths:6, sleeps:12, min:4851,  max:17325,  lat:38.9939, lng:1.4303, min_nights:3,  flexible:true,  tagline:'A beautifully renovated country house with charm throughout', desc:'Elegantly restored farmhouse conveniently located in the rural heart of the island, just a short walk to the village of Santa Gertrudis, a vibrant and popular place full of lively restaurants and galleries.' },
  'can-octavia':    { name:'Can Octavia',     tier:'Essential', area:'San Lorenzo',      beds:6, baths:6, sleeps:12, min:12980, max:15400,  lat:39.0178, lng:1.4794, min_nights:7,  flexible:false, tagline:'Beautifully restored finca with tennis in the heart of Ibiza\'s countryside', desc:'Can Octavia is a 6-bedroom traditional finca lovingly restored and transformed into a captivating home, retaining all its authenticity and charm yet refurbished with every modern comfort you could wish for.' },
  'villa-amado':    { name:'Villa Amado',     tier:'Essential', area:'Jesús',            beds:6, baths:6, sleeps:12, min:8800,  max:38500,  lat:38.9316, lng:1.4540, min_nights:7,  flexible:false, tagline:'Large property close to all the action of the south', desc:'A tropical oasis that offers a perfect blend of luxury, comfort, and natural beauty. Set within a sprawling 2,000 m² estate surrounded by lush Mediterranean gardens and with a private infinity pool.' },
  'villa-brielle':  { name:'Villa Brielle',   tier:'Essential', area:'Cala Tarida',      beds:6, baths:6, sleeps:12, min:9240,  max:18150,  lat:38.9398, lng:1.2711, min_nights:7,  flexible:false, tagline:'Recently renovated with amazing sea and sunset views', desc:'Villa Brielle is an exceptional Ibizan retreat ideally located close to some of the island\'s most desirable sunset beaches on the stunning west coast. Crisp architecture, warm interiors, breathtaking views.' },
  'villa-samy':     { name:'Villa Samy',      tier:'Essential', area:'Cap Martinet',     beds:5, baths:6, sleeps:10, min:4120,  max:15070,  lat:38.9275, lng:1.4606, min_nights:5,  flexible:true,  tagline:'A luxurious haven in Ibiza', desc:'Villa Samy is a breathtaking modern villa that combines authentic Ibizan charm with contemporary sophistication. Built in 2015, this spacious and light-filled property is nestled in one of Ibiza\'s most coveted locations, with beautiful sea views and total privacy.' },
  'can-savasana':   { name:'Can Savasana',    tier:'Essential', area:'Cala Salada',      beds:5, baths:4, sleeps:10, min:6600,  max:11000,  lat:39.0162, lng:1.2988, min_nights:3,  flexible:false, tagline:'Restored 16th-century finca offering timeless tranquility', desc:'From its lofty perch in the quiet pine-clad hills near Cala Salada, Can Savasana enjoys spectacular sea views and grand Ibizan sunsets. The 50,000 m² grounds surrounding the villa provide complete seclusion and serenity.' },
  'villa-trevi':    { name:'Villa Trevi',     tier:'Essential', area:'San Carlos',       beds:4, baths:4, sleeps:8,  min:4400,  max:11000,  lat:39.0149, lng:1.5718, min_nights:4,  flexible:false, tagline:'Cosy villa with saltwater pool, BBQ and beautiful sunrise views', desc:'Nestled in a lush landscape, Villa Trevi offers an idyllic retreat perfect for a relaxing getaway in Ibiza. Classic Ibiza style with rustic accents, a warm inviting atmosphere, and a lovely saltwater pool.' },
  'villa-puma':     { name:'Villa Puma',      tier:'Selected',  area:'Vista Alegre',     beds:6, baths:5, sleeps:12, min:16500, max:22000,  lat:38.8886, lng:1.2905, min_nights:1,  flexible:false, tagline:'Beautiful villa with amazing sea views in a gated community', desc:'Located within the prestigious and secure gated community of Vista Alegre, this six-bedroom house offers a rare combination of privacy, peace of mind, and a prime location close to the best beaches.' },
  'can-josie':      { name:'Can Josie',       tier:'Selected',  area:'San Jose',         beds:6, baths:6, sleeps:12, min:16940, max:32890,  lat:38.8878, lng:1.3301, min_nights:7,  flexible:false, tagline:'A chic bohemian property close to Ibiza\'s most beautiful beaches', desc:'Can Josie is an exquisitely designed 6-bedroom villa located minutes from the bay of Cala Jondal, home to the famed Blue Marlin Beach Club. Set in the hills of San José with stunning sea views.' },
  'villa-margo':    { name:'Villa Margo',     tier:'Selected',  area:'San Jose',         beds:6, baths:5, sleeps:12, min:16500, max:34650,  lat:38.9004, lng:1.3561, min_nights:4,  flexible:false, tagline:'Historic Ibiza estate with panoramic sea views', desc:'Perched atop a sprawling 30,000 m² estate, Villa Margo is a majestic six-bedroom sanctuary where 200 years of history intertwine with modern luxury. This meticulously restored property commands awe-inspiring views.' },
  'villa-adalyn':   { name:'Villa Adalyn',    tier:'Selected',  area:'San Agustín',      beds:6, baths:6, sleeps:12, min:36300, max:41800,  lat:38.9257, lng:1.2804, min_nights:7,  flexible:false, tagline:'A stylish property with distant sea and sunset views', desc:'Villa Adalyn is a spectacularly designed modern 6-bedroom property set high in the hills of San José, a sought-after location close to the village of San Agustín, with breathtaking views over the Mediterranean.' },
  'villa-meghan':   { name:'Villa Meghan',    tier:'Selected',  area:'San Jose',         beds:6, baths:5, sleeps:12, min:16830, max:34650,  lat:38.9039, lng:1.3460, min_nights:7,  flexible:false, tagline:'A luxury finca with spectacular sea views', desc:'Located near Ibiza\'s south-east coast, Villa Meghan is a stunning 6-bedroom villa with breathtaking views of the Mediterranean sea and the picturesque beaches of Playa den Bossa and Formentera beyond.' },
  'can-danza':      { name:'Can Danza',       tier:'Selected',  area:'San Jose',         beds:6, baths:7, sleeps:12, min:17380, max:34650,  lat:38.9168, lng:1.3604, min_nights:7,  flexible:false, tagline:'Lavishly built and uniquely equipped finca', desc:'Can Danza is a magnificent property where each of the 6 bedrooms has been meticulously crafted for the utmost comfort and style. The expansive living spaces flow naturally to the terrace and infinity pool.' },
  'villa-evelyn':   { name:'Villa Evelyn',    tier:'Selected',  area:'Cala Jondal',      beds:4, baths:4, sleeps:8,  min:17050, max:19250,  lat:38.8684, lng:1.3100, min_nights:7,  flexible:true,  tagline:'A stylish villa perched above Cala Jondal', desc:'Villa Evelyn is an elegant contemporary villa set on a pine-clad hillside above Cala Jondal, home to the iconic Blue Marlin beach club. A salt-water infinity pool, rooftop terrace, and sweeping Mediterranean views define this exceptional retreat.' },
  'villa-marielle': { name:'Villa Marielle',  tier:'Private',   area:'San Jose',         beds:5, baths:5, sleeps:10, min:55000, max:110000, lat:38.8920, lng:1.3093, min_nights:7,  flexible:false, tagline:'A breathtaking property with expansive and impeccably designed outdoor living', desc:'Villa Marielle is an exclusive 5-bedroom private residence defined by refined design and quiet elegance. Set in a secluded location between San José and the iconic Cala Comte beach, it offers absolute privacy at its finest.' },
  'villa-bailey':   { name:'Villa Bailey',    tier:'Private',   area:'Es Cubells',       beds:6, baths:6, sleeps:8,  min:63250, max:100100, lat:38.8670, lng:1.2550, min_nights:7,  flexible:false, tagline:'Frontline elegance with panoramic sea views over Es Cubells', desc:'Villa Bailey is an exceptional front-line property set high on a cliffside in the exclusive area of Es Cubells, with direct access to a secluded cove and uninterrupted views across the sea to Formentera.' },
  'can-nemo':       { name:'Can Nemo',        tier:'Private',   area:'Cap Martinet',     beds:6, baths:5, sleeps:12, min:30000, max:95000,  lat:38.9261, lng:1.4690, min_nights:7,  flexible:false, tagline:'Ibiza\'s most iconic super villa with unparalleled service', desc:'Can Nemo is a masterpiece of modern design — Ibiza\'s most iconic super villa. 6 bedrooms, 5 bathrooms, and an estate set over sprawling lush gardens in the most coveted address on the island.' },
  'finca-utopia':   { name:'Finca Utopia',    tier:'Private',   area:'San Lorenzo',      beds:9, baths:9, sleeps:18, min:45000, max:90000,  lat:39.0373, lng:1.4745, min_nights:7,  flexible:false, tagline:'A private 20-acre Ibicencan estate for transformative experiences', desc:'Hidden deep in Ibiza\'s countryside, Finca Utopia is a rare private estate with 9 en-suite suites, created for slow living and celebration alike. 20 acres of unspoiled land, total seclusion, total luxury.' },
  'villa-judith':   { name:'Villa Judith',    tier:'Private',   area:'Cala Llonga',      beds:4, baths:4, sleeps:8,  min:47300, max:51700,  lat:38.9394, lng:1.5050, min_nights:7,  flexible:true,  tagline:'Rustic-chic elegance with panoramic bay views', desc:'Set high above the sea with breathtaking views over the bay of Sol den Serra, Villa Judith combines retro vintage style with modern architecture. Steps from the legendary Amante beach club, it is one of Ibiza\'s finest boutique retreats.' },
  'can-xarraca':    { name:'Can Xarraca',     tier:'Private',   area:'Portinatx',        beds:6, baths:4, sleeps:12, min:15125, max:61600,  lat:39.0999, lng:1.5033, min_nights:7,  flexible:false, tagline:'Divine villa surrounded by pine forests in the north of Ibiza', desc:'A spectacular hideaway with breathtaking sea views, lush private gardens, and direct access to the beach. Situated near the village of Portinatx — the untouched, natural north of the island.' },
  'can-nuri':       { name:'Can Nuri',        tier:'Private',   area:'Sa Caleta',        beds:6, baths:6, sleeps:12, min:27500, max:60500,  lat:38.8713, lng:1.3426, min_nights:3,  flexible:false, tagline:'Modern finca with amazing sea views and a large outdoor space', desc:'Located above Sa Caleta with uninterrupted views over the sea to Formentera and Cap des Falcó. With its saltwater infinity pool, Can Nuri is the ideal retreat for those who value privacy and natural beauty.' },
};
...
function initVillaCollection() {
  ...
  const initMap = () => {
    ...
    const goldIcon = L.divIcon({
      className: '',
      html: '<div style="width:12px;height:12px;background:#b8945f;border:2px solid #fff;border-radius:50%;box-shadow:0 2px 6px rgba(0,0,0,0.3);"></div>',
      iconSize: [12, 12],
      iconAnchor: [6, 6],
    });
    ...
    Object.entries(villaData).forEach(([slug, v]) => {
      ...
      const marker = L.marker([v.lat, v.lng], { icon: goldIcon })
        .bindPopup(popup)
        .addTo(map);
